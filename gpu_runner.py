...
def run_strat(datapoints, data):
    ...
    for item in data:
        ...
        elif price_diff >= buy_on_diff_percent_min and price_diff <= buy_on_diff_percent_max and set_buy is None and set_sell is None and avail_money//price:
            set_buy = price
            transaction_time = time+delay_milis
        elif price_diff >= sell_on_diff_percent_min and price_diff <= sell_on_diff_percent_max and set_buy is None and set_sell is None and current_stocks:
            set_sell = price
            transaction_time = time+delay_milis
